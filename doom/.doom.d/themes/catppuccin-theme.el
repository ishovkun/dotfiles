;;; ~/dotfiles/doom/.doom.d/themes/catppuccin-theme.el -*- lexical-binding: t; -*-
(deftheme catppuccin)
(let* ((class '((class color) (min-colors 89)))
       ...
       (bg-light            surface0)         ;; lighter than main
       (bg-lighter          surface1)       ;; lighter than main
       (bg-dark             mantle)          ;; darker than main background
       (bg-dark-special     crust) ;; solaire color
       (fg                  subtext0)           ;; main foreground
       (fg-dim              surface2)      ;; comments
       (fg-bright           text)
       ;; elements
       (builtin peach)
       (keyword sapphire)
       (const   lavender)         ;; digits
       (comment fg-dim)
       (func    lavender)
       (str     green)
       (type    sky)
       (region  surface0)         ;; basically selection
       (var     blue)
       (warning red)
       (success green)      ;; bright green
       (search-current pink)      ;; current match
  ...
  (custom-theme-set-faces
   ...
   ;; ------ EIN
   `(ein:basecell-input-area-face ((t (:background ,bg :extend t))))
   `(ein:codecell-input-area-face ((t (:background ,bg :extend t))))
   `(ein:htmlcell-input-area-face ((t (:background ,bg :extend t))))
