;;; doom-nord-aurora-mod-theme.el --- a light variant of Nord -*- no-byte-compile: t; -*-
;;
...
(defgroup doom-nord-aurora-mod-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom doom-nord-aurora-mod-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-nord-aurora-mod-theme
  :type 'boolean)

(defcustom doom-nord-aurora-mod-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-nord-aurora-mod-theme
  :type 'boolean)

(defcustom doom-nord-aurora-mod-comment-bg doom-nord-aurora-mod-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'doom-nord-aurora-mod-theme
  :type 'boolean)

(defcustom doom-nord-aurora-mod-padded-modeline doom-themes-padded-modeline
...
(eval-and-compile
  (defcustom doom-nord-aurora-mod-region-highlight t
...
(def-doom-theme doom-nord-aurora-mod
  ...
  ((bg         '("#2E3440" nil       nil            ))
   ...
   (variables      cyan)
   (numbers        orange)
   (region         (pcase doom-nord-aurora-mod-region-highlight
                     (`frost teal)
                     (`snowstorm base7)
                     (_ base4)))
   (error          red)
   ...
   (-modeline-bright doom-nord-aurora-mod-brighter-modeline)
   (-modeline-pad
    (when doom-nord-aurora-mod-padded-modeline
      (if (integerp doom-nord-aurora-mod-padded-modeline) doom-nord-aurora-mod-padded-modeline 4)))

   (region-fg
    (when (memq doom-nord-aurora-mod-region-highlight '(frost snowstorm))
      base0))
  ...
  (((region &override) :foreground region-fg)
   ...
   (font-lock-comment-face
    :foreground comments
    :background (if doom-nord-aurora-mod-comment-bg (doom-lighten bg 0.05) 'unspecified))
   (font-lock-doc-face
...
;;; doom-nord-aurora-mod-theme.el ends here
