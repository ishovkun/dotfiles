;;; themes/tokyo-night-storm-theme.el -*- lexical-binding: t; -*-
...
(let* ((class '((class color) (min-colors 89)))
       ...
       (bg-light            "#343a57") ;; lighter than main
       (bg-lighter          "#424a70") ;; lighter than main
       (bg-dark             "#1b1e2c") ;; darker than main background
       (bg-dark-special     "#1b1e2c") ;; solaire color
       (fg                  "#c0caf5") ;; main foreground
       (fg-dim              base1)     ;; comments
       (fg-bright           base2)
       (region              base0)          ;; basically selection
       ;; elements
       (builtin             orange)
       (keyword             light-blue)
       (const               light-blue)          ;; digits
       (comment             base5)
       (func                blue)
       (str                 dark-green)
       (type                magenta)
