...
(let ((class '((class color) (min-colors 89)))
      (bg1 "#292d3e") ;; main background
      (bg2 "#232635") ;; darker than bg1
      (bg3 "#32374d") ;; ... than main background
      (bg4 "#01657f")
      (fg1 "#c0c6d1")
      (fg2 "#ffffff")
      (fg3 "#4da089")
      (fg4 "#d66083")
      (normal-cursor "#5887ef")
      (key2 "#728e25")
      (key3 "#20db65")                  ;; bright green
      (builtin "#ac87c4")               ;; magenta
      (keyword "#c792ea")               ;; blue
      (const   "#F78C6C")
      (comment "#60739e")
      (func    "#84aaff")               ;; magenta
      ...
      (type    "#51f78b")               ;; cyan
      (region    "#32374d")               ;; whitish
      (var     "#ffcb6b")               ;; same as string
      (warning "#f13333"))              ;; red
  (custom-theme-set-faces
   ...
   `(spacemacs-hybrid-face ((t (:foreground ,str :background ,str :inherit 'mode-line))))
   `(spacemacs-normal-face ((t (:foreground ,bg1 :background ,normal-cursor :inherit 'mode-line))))
   ;; term
   ...
   `(line-number ((,class (:box (:line-width 1 :color ,bg1) :bold t :foreground ,comment :background ,bg1))))
   `(line-number-current-line ((,class (:box (:line-width 1 :color ,bg1) :bold t :foreground ,normal-cursor :background ,bg1 ))))
   ...
   `(js2-function-call ((,class (:foreground ,func))))
   ...
   `(rainbow-delimiters-depth-4-face ((,class :foreground ,func)))
  ...
  (setq
   ...
   evil-normal-state-cursor       `(,normal-cursor box)
